package com.revature.ericschmidt.p1.eventapi.util;
...
public class LoggingAspect {
	...
	@Pointcut("within(com.revature.ericschmidt.p1.eventapi.service.*)")
	public void logWithinServicePackage() {}
	
	@Pointcut("within(com.revature.ericschmidt.p1.eventapi.repository.*)")
