package com.revature.ericschmidt.p1.ticketingapi.util;
...
public class LoggingAspect {
	...
	@Pointcut("within(com.revature.ericschmidt.p1.ticketingapi.service.*)")
	public void logWithinServicePackage() {}
	
	@Pointcut("within(com.revature.ericschmidt.p1.ticketingapi.repository.*)")
